  ...
  return (
    <html lang="en" className={`${inter.variable} ${montserrat.variable} antialiased`}>
      <head>
        ...
        <meta name="google-site-verification" content="veS4hJ1WLQVSdl5w-DAs7TEn8HW672DOWltoW8l4PoI" />
        <meta name="google-site-verification" content="R15UCXiaXXevVUpo0M5JevLtR8wBmo6TpchbSoGuYlQ" />
        <link
